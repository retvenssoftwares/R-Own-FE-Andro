...
class ConnectionsAdapter(val listS : List<ConnectionListDataClass>, val context: Context) : RecyclerView.Adapter<ConnectionsAdapter.ConnectionsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ConnectionsViewHolder, position: Int) {
        ...
        val data = listS[position].conns[position]
        ...
        val mesibo = data.Mesibo_account[position]
