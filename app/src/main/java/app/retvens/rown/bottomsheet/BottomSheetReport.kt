...
import app.retvens.rown.DataCollections.Reasons
...
class BottomSheetReport(val userId:String) : BottomSheetDialogFragment() {
    ...
    private fun report() {
        ...
        val report = RetrofitBuilder.ProfileApis.addreport(ReportDataClass("Profile",user_id,userId,"",
        listOf(Reasons(reportText))))
